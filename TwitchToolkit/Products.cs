...
namespace TwitchToolkit
{
    public class Products
    {
        ...
        public static Product[] GenerateDefaultProducts()
        {
            ...
            {
                new Product(0, 0, "Small raid", "smallraid", KarmaType.Bad, 900, 0),
                new Product(1, 0, "Medium raid", "mediumraid", KarmaType.Bad, 1200, 1),
                new Product(2, 0, "Big raid", "bigraid", KarmaType.Bad, 1800, 2),
                new Product(3, 0, "Medium raid drop", "mediumraiddrop", KarmaType.Bad, 2100, 3),
                new Product(4, 0, "Big raid drop", "bigraiddrop", KarmaType.Bad, 2200, 4),
                new Product(5, 0, "Big siege", "bigsiege", KarmaType.Bad, 1900, 5),
                new Product(6, 0, "Big mechanoid raid", "bigmechanoidraid", KarmaType.Bad, 2400, 6),
                new Product(7, 0, "Infestation", "infestation", KarmaType.Bad, 1600, 7),

                new Product(8, 0, "Heart attack", "heartattack", KarmaType.Bad, 1100, 8),
                new Product(9, 0, "Plague", "plague", KarmaType.Bad, 650, 9),
                new Product(10, 0, "Flu", "flu", KarmaType.Bad, 600, 10),
                new Product(11, 0, "Infection", "infection", KarmaType.Bad, 300, 11),
                new Product(12, 0, "Malaria", "malaria", KarmaType.Bad, 550, 12),
                new Product(13, 0, "Gut worms", "gutworms", KarmaType.Bad, 400, 13),
                new Product(14, 0, "Muscle parasites", "muscleparasites", KarmaType.Bad, 600, 14),

                new Product(15, 0, "Plague medium", "plaguemedium", KarmaType.Bad, 1100, 15),
                new Product(16, 0, "Flu medium", "flumedium", KarmaType.Bad, 1100, 16),
                new Product(17, 0, "Infection medium", "infectionmedium", KarmaType.Bad, 1300, 17),
                new Product(18, 0, "Malaria medium", "malariamedium", KarmaType.Bad, 1300, 18),
                new Product(19, 0, "Gut worms medium", "gutwormsmedium", KarmaType.Bad, 1300, 19),
                new Product(20, 0, "Muscle parasites medium", "muscleparasitesmedium", KarmaType.Bad, 1300, 20),

                new Product(21, 0, "Plague hard", "plaguehard", KarmaType.Bad, 1900, 21),
                new Product(22, 0, "Flu hard", "fluhard", KarmaType.Bad, 1900, 22),
                new Product(23, 0, "Infection hard", "infectionhard", KarmaType.Bad, 1900, 23),
                new Product(24, 0, "Malaria hard", "malariahard", KarmaType.Bad, 1900, 24),
                new Product(25, 0, "Gut worms hard", "gutwormshard", KarmaType.Bad, 1900, 25),
                new Product(26, 0, "Muscle parasites hard", "muscleparasiteshard", KarmaType.Bad, 1900, 26),
                new Product(27, 0, "Blindness", "blindness", KarmaType.Bad, 1900, 27),

                new Product(28, 0, "Clear weather", "clearweather", KarmaType.Good, 400, 28),
                new Product(29, 0, "Rain", "rain", KarmaType.Good, 350, 29),
                new Product(30, 0, "Rainy thunderstorm", "rainythunderstorm", KarmaType.Neutral, 250, 30),
                new Product(31, 0, "Dry thunderstorm", "drythunderstorm", KarmaType.Bad, 450, 31),
                new Product(32, 0, "Snow gentle", "snowgentle", KarmaType.Neutral, 350, 32),
                new Product(33, 0, "Snow hard", "snowhard", KarmaType.Bad, 450, 33),
                new Product(34, 0, "Fog", "fog", KarmaType.Neutral, 300, 34),
                new Product(35, 0, "Foggy rain", "foggyrain", KarmaType.Neutral, 300, 35),
                new Product(36, 0, "Flash storm", "flashstorm", KarmaType.Bad, 300, 36),

                new Product(37, 0, "Eclipse", "eclipse", KarmaType.Bad, 450, 37),
                new Product(38, 0, "Aurora", "aurora", KarmaType.Good, 200, 38),
                ...
                new Product(43, 0, "Blight", "blight", KarmaType.Bad, 700, 43),
                new Product(44, 0, "Solar flare", "solarflare", KarmaType.Bad, 500, 44),
                new Product(45, 0, "Volcanic winter", "volcanicwinter", KarmaType.Doom, 2600, 45),
                new Product(46, 0, "Toxic fallout", "toxicfallout", KarmaType.Doom, 4200, 46),
                new Product(47, 0, "Heat wave", "heatwave", KarmaType.Bad, 750, 47),
                new Product(48, 0, "Cold snap", "coldsnap", KarmaType.Bad, 800, 48),
                new Product(49, 0, "Tornado", "tornado", KarmaType.Bad, -1, 49),
                new Product(50, 0, "Tornados", "tornados", KarmaType.Bad, -1, 50),

                new Product(51, 0, "Wild human", "wildhuman", KarmaType.Good, 300, 51),
                new Product(52, 0, "Wanderer joins", "wandererjoins", KarmaType.Good, 450, 52),
                new Product(53, 0, "Gender swap", "genderswap", KarmaType.Neutral, 150, 53),
                new Product(54, 0, "Skill increase", "skillincrease", KarmaType.Good, 200, 54),
                new Product(55, 0, "Party", "party", KarmaType.Good, 400, 55),
                new Product(56, 0, "Cannibal", "cannibal", KarmaType.Bad, 750, 56),
                new Product(57, 0, "Luciferium", "luciferium", KarmaType.Doom, 6000, 57),
                ...
                new Product(61, 0, "Rare thrumbos", "thrumbos", KarmaType.Good, 500, 61),
                new Product(62, 0, "Farm animals", "farmanimals", KarmaType.Good, 200, 62),
                new Product(63, 0, "Animal self-tamed", "animalselftame", KarmaType.Good, 150, 63),
                ...
                new Product(71, 0, "Minor mental break", "minormentalbreak", KarmaType.Bad, 300, 71),
                new Product(72, 0, "Major mental break", "majormentalbreak", KarmaType.Bad, 900, 72),
                ...
                new Product(78, 0, "Ship part poison", "shippartpoison", KarmaType.Bad, 1500, 78),
                new Product(79, 0, "Ship part psychic", "shippartpsychic", KarmaType.Bad, 2200, 79),
                new Product(80, 1, "Care package", "carepackage", KarmaType.Good, -1, 80),

                new Product(81, 0, "Man in black", "maninblack", KarmaType.Good, 350, 81),
                new Product(82, 0, "Refugee chased", "refugeechased", KarmaType.Neutral, 650, 82),
                new Product(83, 0, "Traveler", "traveler", KarmaType.Good, 350, 83),
                new Product(84, 0, "Visitor", "visitor", KarmaType.Good, 200, 84),
                new Product(85, 0, "Trader visting", "tradervisiting", KarmaType.Good, 275, 85),
                new Product(86, 0, "Trader ship", "tradership", KarmaType.Good, 350, 86),
                new Product(87, 0, "Military Aid", "militaryaid", KarmaType.Good, 700, 87),
            };
