...
public class DryThunderStorm : IncidentHelper
{
	...
	{
		weather = DefDatabase<WeatherDef>.GetNamed("DryThunderstorm", true);
	...
	public override void TryExecute()
	{
		...
		Helper.Weather((TaggedString)(Translator.Translate("TwitchStoriesDescription32")), weather, LetterDefOf.PositiveEvent);
	}
}
