...
public class SnowHard : IncidentHelper
{
	...
	{
		weather = DefDatabase<WeatherDef>.GetNamed("SnowHard", true);
	...
	public override void TryExecute()
	{
		...
		Helper.Weather((TaggedString)(Translator.Translate("TwitchStoriesDescription34")), weather, LetterDefOf.PositiveEvent);
	}
}
