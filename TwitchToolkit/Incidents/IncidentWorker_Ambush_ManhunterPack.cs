...
namespace TwitchToolkit.Incidents
{
    public class IncidentWorker_Ambush_ManhunterPack : IncidentWorker_Ambush
    {
        ...
        public IncidentWorker_Ambush_ManhunterPack(string quote)
        {
            Quote = quote;
        }
        ...
        protected override string GetLetterText(Pawn anyPawn, IncidentParms parms)
        {
            ...
            var text = string.Format(def.letterText, (caravan == null) ? "yourCaravan".Translate() : caravan.Name, anyPawn.GetKindLabelPlural(-1)).CapitalizeFirst();
