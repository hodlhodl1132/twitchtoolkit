...
namespace TwitchToolkit.Incidents
{
    public class IncidentWorker_ShipChunkDrop : IncidentWorker
    {
        ...
        public IncidentWorker_ShipChunkDrop(string quote)
        {
            Quote = quote;
        }
      ...
      new Pair<int, float>(4, 0.4f)
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            var text = "MessageShipChunkDrop".Translate();
            ...
            Find.LetterStack.ReceiveLetter("Ship chunk", text, LetterDefOf.PositiveEvent, new TargetInfo(intVec, map, false), null, null);
            return true;
        }
